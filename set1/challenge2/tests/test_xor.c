...
void test_xor_binarrays_null(void)
{
	...
	TEST_BYTE_ARR_EQ(xor_binarrays(NULL, NULL, 0), NULL, 0);
	TEST_BYTE_ARR_EQ(xor_binarrays(bits, NULL, 1), NULL, 0);
	TEST_BYTE_ARR_EQ(xor_binarrays(NULL, bits, 1), NULL, 0);
}
...
void test_xor_binarrays_two_bytes(void)
{
	...
	TEST_BYTE_ARR_EQ(expected, actual, 2);
